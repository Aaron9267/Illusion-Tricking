...
const classes = () => {
    return (
        <div>
            <Hero 
            heading='Classes' 
            message='The timetable for 2024 term 1 is below.' 
            message1='Go to contact to enroll for a class. $125 for the term or $15 for casual sessions'
            message2='We can also arrange private sessions for tricking, tumbling and acro. $60 per private'
