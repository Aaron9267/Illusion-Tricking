...
const classes = () => {
    return (
        <div>
            <Hero 
            heading='Classes' 
            message='In term 4 we will be introducing a tumbling class that runs after the tricking session on Saturday.' 
            message1='The timetable for term 4 is below.'
            message2='You can go to contact to enroll. $100 per term or $10 for a casual session'
